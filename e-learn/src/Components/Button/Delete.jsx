...
export default function Delete({ onClick }) {
    return (
        <button className={`${classes.button} ${classes.delete_button}`} onClick={onClick}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 69 14" className={`${classes.svgIcon} ${classes.bin_top}`}>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 69 57" className={`${classes.svgIcon} ${classes.bin_bottom}`}>
